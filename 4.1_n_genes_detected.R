# choose cancer and load the data
cancer <- "KIRC"
...
logCPM_sub <- logCPM_all[, genes_detect_sub]
...
ggsave(n_genes_detect_final_plot, filename = "pdf/suppl/n_genes_and_distrib_mRNA.pdf")
